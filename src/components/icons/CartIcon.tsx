...
const CartIcon: React.FC<IconProps> = ({ color, width, height }) => {
  return (
    <svg className="hover:motion-preset-shake" xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox={`0 0 44 44`} fill="none">
      <g clipPath="url(#clip0_40_296)">
        <path
      ...
      <defs>
        <clipPath id="clip0_40_296">
          <rect width={width} height={height} fill="white" transform="matrix(-1 0 0 1 43.6125 0)" />
        </clipPath>
      </defs>
    </svg>
  );
